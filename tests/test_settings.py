...
def test_read_config() -> None:
    ...
    # Arrange
    args = argparse.Namespace(config_path=DATA_PATH / "testconfig.toml")
    args.db_path = DATA_PATH / "frcattend.db"
    # Act
    ...
    assert config.settings.email_sender_name == "FRC Attendance System"
